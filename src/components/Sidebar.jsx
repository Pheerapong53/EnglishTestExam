...
function Sidebar() {
  ...
  const handleLogout = async () => {
    ...
    await logoutHandler(idTokenResult, pers_id)
    .then((res) => {
      dispatch(logout());
    ...
    <> <Box sx={{ display: "flex" }}>
        ...
        <AppBar position="fixed" open={open}>
          ...
          <Toolbar>
            ...
            <Typography variant="h6" noWrap component="div" sx={{ display: { md: "block", xs: "block" }}}>
        ...
        <Drawer variant="permanent" open={open}>
          ...
          <Divider />
          <Link exact="true" to="/PageHome" style={{ textDecoration: "none", color: "black" }} >
          <List>
            <ListItemButton
              sx={{
                height: 40,
          ...
          <Divider />
          <Link to="/PageMember" style={{ textDecoration: "none", color: "black" }}>
          <List>
            <ListItemButton
              sx={{
                height: 40,
          ...
          <Divider />
          <Link to="/PageBookTestDate" style={{ textDecoration: "none", color: "black" }}>
          <List>
            <ListItemButton
              sx={{
                height: 40,
          ...
          <Divider />
          <Link to="/PageDoTest" style={{ textDecoration: "none", color: "black" }}>
          <List>
            <ListItemButton
              sx={{
                height: 40,
          ...
          <Divider />
          <Link to="/PageTestManagement" style={{ textDecoration: "none", color: "black" }}>
          <List>
            <ListItemButton
              sx={{
                height: 40,
          ...
          <Divider />
          <Link to="/PageExamArchive" style={{ textDecoration: "none", color: "black" }}>
          <List>
            <ListItemButton
              sx={{
                height: 40,
          ...
          <Link to={USR01 === '1' && USR02 === '0' && USR03 === '0' && USR04 === '0' && USR05 === '0' ? "/ContentViewTestScores" : "/PageTestScores"}  state={{
             pers_id: pers_idIndi,
             mem_rank: rankIndi,
             mem_fname: fnameIndi,
             mem_lname: lnameIndi,
          ...
          <Divider />
          <Link to="/PageManageMembers" style={{ textDecoration: "none", color: "black" }}>
          <List>
            <ListItemButton
              sx={{
                height: 40,
          ...
          <Divider />
          <Link to="/ContentPageSettingWeb" style={{ textDecoration: "none", color: "black" }}>
          <List>
            <ListItemButton
              sx={{
                height: 40,
          ...
          <Divider />
          <Link to="/ContentTeamDev" style={{ textDecoration: "none", color: "black" }}>
          <List>
            <ListItemButton
              sx={{
                height: 40,
...
{/* TEXT */}
{
  ...
  : location.pathname === "/PageTestManagement" ? (<ContentPageTestManagement />)
  : location.pathname === "/PageExamArchive" ? (<ContentPageExamArchive />)
  : location.pathname === "/PageExamInformation" ? (<ContentPageExamInformation />)
  : location.pathname === "/PageExaminer" ? (<ContentPageExaminer />)
  : location.pathname === "/PageCoorDinaTor" ? (<ContentPageCoorDinaTor />)
  : location.pathname === "/PageSuperVisor" ? (<ContentPageSuperVisor />)
  : location.pathname === "/PageAdmin" ? (<ContentPageAdmin />)
  : location.pathname === "/PageCheckApproval" ? (<ContentPageCheckApproval />) 
  : location.pathname === "/PageExamArchiveLookExam" ? (<ContentPageExamArchiveLookExam />) 
  : location.pathname === "/PagePublicRelationsManagement" ? (<ContentPagePublicRelationsManagement />) 
  : location.pathname === "/PageLookLab" ? (<ContentLookLab />)
  : location.pathname === "/PageManageMembers" ? (<PageManageMembers />)
  : location.pathname === "/PageTestScores" ? (<PageTestScores />)
  : location.pathname === "/ContentPageTestScores" ? (<ContentPageTestScores />)
  : location.pathname === "/ContentIndividualScores" ? (<ContentIndividualScores />)
  : location.pathname === "/ContentViewTestScores" ? (<ContentViewTestScores />)
  : location.pathname === "/ContentPageSettingWeb" ? (<ContentPageSettingWeb />)
  : location.pathname === "/ContentListScores" ? (<ContentListScores />)
  : location.pathname === "/ContentPageListTestScores" ? (<ContentPageListTestScores />)
