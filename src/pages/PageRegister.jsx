...
// Functions
import { searchHandler, registerHandler } from "../components/functions/user";
...
function PageRegister() {
  ...
  const handleSubmit = async (event) => {
    ...
    // console.log("formValues: ", formValues.officeid.value || officeid)
    // console.log("formValues: ", formValues)
    // console.log("idc: ", idc.length)
    // console.log("officeid: ", officeid)

    const numberPattern = /^\d+$/;
    // const thaiPattern = /^[ก-๏\s]+$/u;
    // const thaiPattern = /^[\u0E00-\u0E7F]+$/;
    ...
    // function checkThaiOrEnglish(str) {

    //   if (thaiPattern.test(str)) {
    //     console.log('The string contains only Thai characters');
    //   } else if (englishPattern.test(str)) {
    //     console.log('The string contains only English characters');
    //   } else {
    //     console.log('The string contains a mix of Thai and English characters');
    //   }
    // }
    // checkThaiOrEnglish(email.value);
    ...
    for (let index = 0; index < formFields.length; index++) {
      ...
      // console.log("formValues: ", formValues.values);
      // // console.log("length: ", pers_id.value.length);
      // console.log("pers_id length: ", pers_id.length);
      // console.log("idc length: ", idc.length);

      // // console.log("data");
      // console.log("official_id: ", official_id.value.length);
      // console.log("officeid: ", officeid.length);
  ...
  const handleChange = async (e) => {
    ...
    // if (formValues.fname.value.match(regexp)) {
    //   setFormValues((prevState) => ({
    //     ...prevState,
    //     fname: {
    //       ...prevState.fname,
  ...
  // console.log("offID:",formValues.official_id.value.length)
